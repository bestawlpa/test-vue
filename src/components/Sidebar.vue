<template>
    <div class=" w-[335px] ">
        ...
        <button class=" h-[50px] w-[270px] focus:bg-[#feffff]  focus:shadow-md rounded-lg flex items-center px-[15px]">
          ...
          <h1 class=" text-[#5D6B85] text-[18px]  font-normal">Menu 4</h1>
        </button> 

        <div class=" mt-[100px] flex flex-col justify-between items-center rounded-xl py-6 w-[270px] h-[140px] bg-gradient-to-l from-[#9aa5bd] to-[#b0bcd3]  ">
            <div class=" w-[240px] text-[#ffffff] font-medium">
                <h1 class=" text-[18px]">
                    Need help?
                </h1>
                <h4 class=" text-[12px]">
            ...
            <div class=" w-[335px] flex justify-center">
                <button class="h-[40px] w-[240px] bg-[#ffffff] rounded-lg text-[15px] text-[#000000] font-semibold">
                DOCUMENTATION
            </button>
            </div>
        </div>
